...
public class OrderUtils {
	...
	case Stock:
	    return new StockOrder(symbol, side, BigDecimal.valueOf(price), BigDecimal.valueOf(quantity));
	case Future:
	    return new FutureOrder(symbol, side, BigDecimal.valueOf(price));
	case Option:
	    return new OptionOrder(symbol, side, BigDecimal.valueOf(price), BigDecimal.valueOf(quantity));
	default:
