...
public class TickTableTest {
    ...
    @BeforeEach
    public void setUp() {
        BigDecimal[] segments = new BigDecimal[] {
                BigDecimal.valueOf(0.0), BigDecimal.valueOf(10.0), BigDecimal.valueOf(20.0),
                BigDecimal.valueOf(30.0), BigDecimal.valueOf(40.0)
        };
        BigDecimal[] tickSizes = new BigDecimal[] {
                BigDecimal.valueOf(0.01), BigDecimal.valueOf(0.05), BigDecimal.valueOf(0.1),
                BigDecimal.valueOf(0.25), BigDecimal.valueOf(0.5)
        };
